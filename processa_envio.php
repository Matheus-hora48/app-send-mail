...
require "./src/PHPMailer/OAuth.php";
...
try {
  ...
  $mail->Username   = 'teste@email.com';                     //Coloque aqui seu email
  $mail->Password   = '********';                               //Coloque aqui sua senha
  $mail->SMTPSecure = 'tls';         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
  $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

  //Recipients
  $mail->setFrom('horadoido4@gmail.com', 'Hora');
  $mail->addAddress('acfaj2010@gmail.com', 'Jr');     //Add a recipient
  ...
  $mail->AltBody = 'É nescessario utilizar um client que suporta HTML para ter acesso total ao conteúdo dessa mensagem';
